...
pacman::p_load(tidyr, fredr, dplyr, ggplot2, patchwork, urca, tseries, zoo, vars, forecast, patchwork, Metrics, gridExtra, knitr, kableExtra, purrr, tibble)
...
```{r exercise_1/3_Graphs, include=FALSE}
